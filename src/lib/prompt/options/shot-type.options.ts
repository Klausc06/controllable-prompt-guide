...
export const shotTypeOptions: OptionSet = {
  ...
  options: [
    ...
    },
    {
      ...
      appliesTo: ["seedance", "generic_video", "veo3"],
      riskHint: { zh: "极端低角度可能导致主体比例失真或背景透视异常。", en: "Extreme low angles may cause subject proportion distortion or background perspective anomalies." }
    },
    {
      ...
      appliesTo: ["seedance", "generic_video", "veo3"],
      riskHint: { zh: "高角度俯拍可能导致场景扁平化，失去空间深度感。", en: "High angle shots may flatten the scene, losing spatial depth perception." }
    },
    {
    ...
    },
    {
      ...
      appliesTo: ["seedance", "generic_video", "veo3"],
      riskHint: { zh: "分屏合成可能因模型对画面边界的理解不准确而出现错位。", en: "Split-screen compositing may misalign due to the model's imperfect understanding of frame boundaries." }
    },
    {
